;!function(e){
    ...
    n.prototype.define=function(e,t){
        var n=this,r="function"==typeof e,
        i=function(){
    ...
    n.prototype.use=function(e,n,l){
        ...
        function c(){
            l.push(layui[f]),
            e.length>1?p.use(e.slice(1),n,l):
        ...
        window.jQuery&&jQuery.fn.on&&(p.each(e,function(t,o){
            "jquery"===o&&e.splice(t,1)
        }),
        layui.jquery=layui.$=jQuery);
        
        var f=e[0],m=0;
        if(l=l||[],o.host=o.host||(y.match(/\/\/([\s\S]+?)\//)||["//"+location.host+"/"])[0],
        ...
        if(o.modules[f])!function g(){
            ...
            h=(u[f]?y+"lay/":/^\{\/\}/.test(p.modules[f])?"":o.base||"")+(p.modules[f]||f)+".js";h=h.replace(/^\{\/\}/,""),
            v.async=!0,v.charset="utf-8",
            v.src=h+function(){
                var e=o.version===!0?o.v||(new Date).getTime():
                    o.version||"";return e?"?v="+e:""
                }(),
                d.appendChild(v),
                ...
                !1):
                    ...
                    function(e){s(e,h)}),o.modules[f]=h}return p},
                    n.prototype.getStyle=function(t,o){
                        var n=t.currentStyle?t.currentStyle:
                    ...
                    n.prototype.link=function(e,n,r){
                        ...
                        "function"!=typeof n?a:(function y(){
                            return++p>1e3*o.timeout/100?i(e+" timeout"):
                                void(1989===parseInt(a.getStyle(t.getElementById(c),"width"))?function(){
                                    n()
                                }():setTimeout(y,100))
                            }(),
                        a)},
                        n.prototype.addcss=function(e,t,n){
                            ...
                            n.prototype.router=function(e){
                                ...
                                return/^#\//.test(e)?(e=e.replace(/^#\//,"").replace(/([^#])(#.*$)/,"$1").split("/")||[],
                                    t.each(e,function(e,t){
                                        /^\w+=/.test(t)?function(){
                                            t=t.split("="),
                                            o.search[t[0]]=t[1]}():o.path.push(t)
                                        }),
                                o):o
                            },
                            n.prototype.data=function(t,o){
                                if(t=t||"layui",e.JSON&&e.JSON.parse){
                                    ...
                                    o="object"==typeof o?o:{
                                        ...
                                        return"value"in o&&(n[o.key]=o.value),
                            ...
                            n.prototype.event=function(e,t,n){
                                ...
                                u=(t=e+"."+t).replace(a,""),
                                l=function(e,t){
                                    var o=t&&t.call(r,n);o===!1&&null===i&&(i=!1)
                                };
                                return layui.each(o.event[u],l),
                                a[0]&&layui.each(o.event[t],l),
                                i
                            },
                            e.layui=new n
}(window);
